        ...
        links.forEach(link => {
            ...
            if (linkPageName === pageName) {
                if (isMobile) {
                    ...
                    link.className = 'text-primary-600 font-medium transition-colors hover:text-primary-500';
                }
            } else {
                if (isMobile) {
                    link.className = 'block px-3 py-3 text-gray-600 dark:text-gray-300 font-medium rounded-lg';
                } else {
                    link.className = 'text-gray-600 dark:text-gray-300 font-medium transition-colors hover:text-primary-600 dark:hover:text-primary-400';
                }
            }
        });
    }
